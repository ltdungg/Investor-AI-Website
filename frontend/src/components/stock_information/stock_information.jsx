                    ...
                    <div className="financial-data-section">
                        ...
                        {stockInformation?.financialData?.balanceSheet && (
                            <div className="financial-table-container">
                                ...
                                <table className="financial-table">
                                    <tbody>
                                        {stockInformation.financialData.balanceSheet.map(
                                            (item, index) => (
                                                <tr key={index}>
                                                    <td>{item.metric}</td>
                                                    <td>{item.value}</td>
                        ...
                        {stockInformation?.financialData?.incomeStatement && (
                            <div className="financial-table-container">
                                ...
                                <table className="financial-table">
                                    <tbody>
                                        {stockInformation.financialData.incomeStatement.map(
                                            (item, index) => (
                                                <tr key={index}>
                                                    <td>{item.metric}</td>
                                                    <td>{item.value}</td>
                        ...
                        {stockInformation?.financialData?.cashFlow && (
                            <div className="financial-table-container">
                                ...
                                <table className="financial-table">
                                    <tbody>
                                        {stockInformation.financialData.cashFlow.map(
                                            (item, index) => (
                                                <tr key={index}>
                                                    <td>{item.metric}</td>
                                                    <td>{item.value}</td>
