...
@Tag(name = "Báo Cáo Lưu Chuyển Tiền Tệ")
public class FinanceCashFlowController {
    @Autowired
    @Qualifier("FinanceCashFlow")
    QuarterlyFinancialData quarterlyFinancialData;

    @Operation(summary = "báo cáo lưu chuyền tiền tệ của từng quý của các năm")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "trả về báo cáo lưu chuyền tiền tệ của một cổ phiếu từng quý của các năm"),
